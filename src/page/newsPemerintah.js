...
export class NewsPemerintah extends Component {
  static propTypes = {
    prop: PropTypes
  }
  ...
  render() {
    return (
      <div>
        <link rel="stylesheet" href="/css/News Pemerintah.css"/>
        <div class="container">
        <div className="row">
            <div className="col-sm-9">
                <h3>KNPI NEWS</h3>
                <h5>Kategori Suara Pemerintah</h5>
                <div className="row">
                    <div className="col-sm-4">
                        <div className="news-box">
                            <a href="">
                                <img src="/image/pemerintah-indonesia-dan-australia.jpg" alt=""/>
                            </a>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-sm-4">
                        <div className="news-box">
                            <a href="">
                                <img src="/image/alasan-pemerintah.png" alt=""/>
                            </a>
                        </div>
                    </div>
                    <div className="col-sm-8">
                ...
                <div className="row">
                    <div className="col-sm-4">
                        <div className="news-box">
                            <a href="">
                                <img src="/image/kabinet-kerja-jokowi.png" alt=""/>
                            </a>
                        </div>
                    </div>
                    <div className="col-sm-8">
                ...
                <div className="row">
                    <div className="col-sm-4">
                        <div className="news-box">
                            <a href="">
                                <img src="/image/hipwee-pemerintah-indonesia.jpg" alt=""/>
                            </a>
                        </div>
                    </div>
                    <div className="col-sm-8">
