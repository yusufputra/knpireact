...
export class Pengaduan extends Component {
  ...
  constructor(props){
    ...
    send = (event) =>{
        ...
        console.log(body)
        fetch('http://localhost:5000/pubs/postPengaduan',{
            method : 'POST',
            headers : {
                ...
                <div className="row">
                    <div className="col-sm-8">
                        ...
                        <form onSubmit={this.send}>
                            ...
                            <div className="form-group">
                                <label for="subjek">Nama Ormas*</label>
                                <input type="text" className="form-control" name="subjek" id="ormas" placeholder="Nama Ormas" onChange={this.handlerEvent} required/>
                            </div>
                            <div className="form-group">
